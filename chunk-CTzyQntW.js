...
`],encapsulation:2})}return i})();var Wt=(()=>{class i{static ɵfac=function(t){return new(t||i)};static ɵmod=Nl({type:i});static ɵinj=Ki({providers:[Bt$1,{provide:ui,useValue:{separatorKeyCodes:[13]}}],imports:[Kr,pt]})}return i})();var Re=new B(`CdkAccordion`);var Ut=(()=>{class i{_stateChanges=new we$1;_openCloseAllActions=new we$1;id=M(Zt$1).getId(`cdk-accordion-`);multi=!1;openAll(){this.multi&&this._openCloseAllActions.next(!0)}closeAll(){this._openCloseAllActions.next(!1)}ngOnChanges(e){this._stateChanges.next(e)}ngOnDestroy(){this._stateChanges.complete(),this._openCloseAllActions.complete()}static ɵfac=function(t){return new(t||i)};static ɵdir=kl({type:i,selectors:[[`cdk-accordion`],[``,`cdkAccordion`,``]],inputs:{multi:[2,`multi`,`multi`,rb]},exportAs:[`cdkAccordion`],features:[gw([{provide:Re,useExisting:i}]),Xu]})}return i})();var Zt=(()=>{class i{accordion=M(Re,{optional:!0,skipSelf:!0});_changeDetectorRef=M(_g);_expansionDispatcher=M(Ee$2);_openCloseAllSubscription=Ee$1.EMPTY;closed=new Lt$1;opened=new Lt$1;destroyed=new Lt$1;expandedChange=new Lt$1;id=M(Zt$1).getId(`cdk-accordion-child-`);get expanded(){return this._expanded}set expanded(e){if(this._expanded!==e){if(this._expanded=e,this.expandedChange.emit(e),e){this.opened.emit();let t=this.accordion?this.accordion.id:this.id;this._expansionDispatcher.notify(this.id,t)}else this.closed.emit();this._changeDetectorRef.markForCheck()}}_expanded=!1;get disabled(){return this._disabled()}set disabled(e){this._disabled.set(e)}_disabled=_r(!1);_removeUniqueSelectionListener=()=>{};ngOnInit(){this._removeUniqueSelectionListener=this._expansionDispatcher.listen((e,t)=>{this.accordion&&!this.accordion.multi&&this.accordion.id===t&&this.id!==e&&(this.expanded=!1)}),this.accordion&&(this._openCloseAllSubscription=this._subscribeToOpenCloseAllActions())}ngOnDestroy(){this.opened.complete(),this.closed.complete(),this.destroyed.emit(),this.destroyed.complete(),this._removeUniqueSelectionListener(),this._openCloseAllSubscription.unsubscribe()}toggle(){this.disabled||(this.expanded=!this.expanded)}close(){this.disabled||(this.expanded=!1)}open(){this.disabled||(this.expanded=!0)}_subscribeToOpenCloseAllActions(){return this.accordion._openCloseAllActions.subscribe(e=>{this.disabled||(this.expanded=e)})}static ɵfac=function(t){return new(t||i)};static ɵdir=kl({type:i,selectors:[[`cdk-accordion-item`],[``,`cdkAccordionItem`,``]],inputs:{expanded:[2,`expanded`,`expanded`,rb],disabled:[2,`disabled`,`disabled`,rb]},outputs:{closed:`closed`,opened:`opened`,destroyed:`destroyed`,expandedChange:`expandedChange`},exportAs:[`cdkAccordionItem`],features:[gw([{provide:Re,useValue:void 0}])]})}return i})();var Xt=(()=>{class i{static ɵfac=function(t){return new(t||i)};static ɵmod=Nl({type:i});static ɵinj=Ki({})}return i})();var fi=[`body`];var vi=[`bodyWrapper`];var yi=[[[`mat-expansion-panel-header`]],`*`,[[`mat-action-row`]]];var bi=[`mat-expansion-panel-header`,`*`,`mat-action-row`];function xi(i,a){}var Si=[[[`mat-panel-title`]],[[`mat-panel-description`]],`*`];var wi=[`mat-panel-title`,`mat-panel-description`,`*`];function Ci(i,a){i&1&&(jl(0,`span`,1),Qf(),jl(1,`svg`,2),Gm(2,`path`,3),Bl()())}var ze=new B(`MAT_ACCORDION`);var Yt=new B(`MAT_EXPANSION_PANEL`);var Ni=(()=>{class i{_template=M(Lr);_expansionPanel=M(Yt,{optional:!0});static ɵfac=function(t){return new(t||i)};static ɵdir=kl({type:i,selectors:[[`ng-template`,`matExpansionPanelContent`,``]]})}return i})();var Jt=new B(`MAT_EXPANSION_PANEL_DEFAULT_OPTIONS`);var He=(()=>{class i extends Zt{_viewContainerRef=M($r);_animationsDisabled=ge();_document=M(Ge);_ngZone=M(Te$1);_elementRef=M(er);_renderer=M(Oo);_cleanupTransitionEnd;get hideToggle(){return this._hideToggle||this.accordion&&this.accordion.hideToggle}set hideToggle(e){this._hideToggle=e}_hideToggle=!1;get togglePosition(){return this._togglePosition||this.accordion&&this.accordion.togglePosition}set togglePosition(e){this._togglePosition=e}_togglePosition;afterExpand=new Lt$1;afterCollapse=new Lt$1;_inputChanges=new we$1;accordion=M(ze,{optional:!0,skipSelf:!0});_lazyContent;_body;_bodyWrapper;_portal;_headerId=M(Zt$1).getId(`mat-expansion-panel-header-`);constructor(){super();let e=M(Jt,{optional:!0});this._expansionDispatcher=M(Ee$2),e&&(this.hideToggle=e.hideToggle)}_hasSpacing(){return this.accordion?this.expanded&&this.accordion.displayMode==="default":!1}_getExpandedState(){return this.expanded?`expanded`:`collapsed`}toggle(){this.expanded=!this.expanded}close(){this.expanded=!1}open(){this.expanded=!0}ngAfterContentInit(){this._lazyContent&&this._lazyContent._expansionPanel===this&&this.opened.pipe(h0(null),io(()=>this.expanded&&!this._portal),gr(1)).subscribe(()=>{this._portal=new Hr$1(this._lazyContent._template,this._viewContainerRef)}),this._setupAnimationEvents()}ngOnChanges(e){this._inputChanges.next(e)}ngOnDestroy(){super.ngOnDestroy(),this._cleanupTransitionEnd?.(),this._inputChanges.complete()}_containsFocus(){if(this._body){let e=this._document.activeElement,t=this._body.nativeElement;return e===t||t.contains(e)}return!1}_transitionEndListener=({target:e,propertyName:t})=>{e===this._bodyWrapper?.nativeElement&&t===`grid-template-rows`&&this._ngZone.run(()=>{this.expanded?this.afterExpand.emit():this.afterCollapse.emit()})};_setupAnimationEvents(){this._ngZone.runOutsideAngular(()=>{this._animationsDisabled?(this.opened.subscribe(()=>this._ngZone.run(()=>this.afterExpand.emit())),this.closed.subscribe(()=>this._ngZone.run(()=>this.afterCollapse.emit()))):setTimeout(()=>{let e=this._elementRef.nativeElement;this._cleanupTransitionEnd=this._renderer.listen(e,`transitionend`,this._transitionEndListener),e.classList.add(`mat-expansion-panel-animations-enabled`)},200)})}static ɵfac=function(t){return new(t||i)};static ɵcmp=ZC({type:i,selectors:[[`mat-expansion-panel`]],contentQueries:function(t,n,o){if(t&1&&Xm(o,Ni,5),t&2){let c;LI(c=jI())&&(n._lazyContent=c.first)}},viewQuery:function(t,n){if(t&1&&Jm(fi,5)(vi,5),t&2){let o;LI(o=jI())&&(n._body=o.first),LI(o=jI())&&(n._bodyWrapper=o.first)}},hostAttrs:[1,`mat-expansion-panel`],hostVars:4,hostBindings:function(t,n){t&2&&ig(`mat-expanded`,n.expanded)(`mat-expansion-panel-spacing`,n._hasSpacing())},inputs:{hideToggle:[2,`hideToggle`,`hideToggle`,rb],togglePosition:`togglePosition`},outputs:{afterExpand:`afterExpand`,afterCollapse:`afterCollapse`},exportAs:[`matExpansionPanel`],features:[gw([{provide:ze,useValue:void 0},{provide:Yt,useExisting:i}]),Pm,Xu],ngContentSelectors:bi,decls:9,vars:4,consts:[[`bodyWrapper`,``],[`body`,``],[1,`mat-expansion-panel-content-wrapper`],[`role`,`region`,1,`mat-expansion-panel-content`,3,`id`],[1,`mat-expansion-panel-body`],[3,`cdkPortalOutlet`]],template:function(t,n){t&1&&(OI(yi),PI(0),qs(1,`div`,2,0)(3,`div`,3,1)(5,`div`,4),PI(6,1),Lm(7,xi,0,0,`ng-template`,5),Ll(),PI(8,2),Ll()()),t&2&&(mE(),$m(`inert`,n.expanded?null:``),mE(2),Um(`id`,n.id),$m(`aria-labelledby`,n._headerId),mE(4),Um(`cdkPortalOutlet`,n._portal))},dependencies:[ka],styles:[`.mat-expansion-panel {
  box-sizing: content-box;
  display: block;
  margin: 0;
  overflow: hidden;
