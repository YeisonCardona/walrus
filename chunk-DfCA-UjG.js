...
`;var Ht=new V(`MAT_GRID_LIST`);var Fe=(()=>{class i{_element=M(nr);_gridList=M(Ht,{optional:!0});_rowspan=1;_colspan=1;get rowspan(){return this._rowspan}set rowspan(e){this._rowspan=Math.round(Dt(e))}get colspan(){return this._colspan}set colspan(e){this._colspan=Math.round(Dt(e))}_setStyle(e,t){this._element.nativeElement.style[e]=t}static ɵfac=function(t){return new(t||i)};static ɵcmp=JC({type:i,selectors:[[`mat-grid-tile`]],hostAttrs:[1,`mat-grid-tile`],hostVars:2,hostBindings:function(t,n){t&2&&Um(`rowspan`,n.rowspan)(`colspan`,n.colspan)},inputs:{rowspan:`rowspan`,colspan:`colspan`},exportAs:[`matGridTile`],ngContentSelectors:zt,decls:2,vars:0,consts:[[1,`mat-grid-tile-content`]],template:function(t,n){t&1&&(jI(),Vl(0,`div`,0),BI(1),Hl())},styles:[`.mat-grid-list {
  display: block;
  position: relative;
}
...
`],encapsulation:2})}return i})();var ci=/^-?\d+((\.\d+)?[A-Za-z%$]?)+$/;var ce=class{_gutterSize;_rows=0;_rowspan=0;_cols;_direction;init(a,e,t,n){this._gutterSize=Ot(a),this._rows=e.rowCount,this._rowspan=e.rowspan,this._cols=t,this._direction=n}getBaseTileSize(a,e){return`(${a}% - (${this._gutterSize} * ${e}))`}getTilePosition(a,e){return e===0?`0`:K(`(${a} + ${this._gutterSize}) * ${e}`)}getTileSize(a,e){return`(${a} * ${e}) + (${e-1} * ${this._gutterSize})`}setStyle(a,e,t){let n=100/this._cols,o=(this._cols-1)/this._cols;this.setColStyles(a,t,n,o),this.setRowStyles(a,e,n,o)}setColStyles(a,e,t,n){let o=this.getBaseTileSize(t,n),c=this._direction===`rtl`?`right`:`left`;a._setStyle(c,this.getTilePosition(o,e)),a._setStyle(`width`,K(this.getTileSize(o,a.colspan)))}getGutterSpan(){return`${this._gutterSize} * (${this._rowspan} - 1)`}getTileSpan(a){return`${this._rowspan} * ${this.getTileSize(a,1)}`}getComputedHeight(){return null}};var Te=class extends ce{fixedRowHeight;constructor(a){super(),this.fixedRowHeight=a}init(a,e,t,n){super.init(a,e,t,n),this.fixedRowHeight=Ot(this.fixedRowHeight),ci.test(this.fixedRowHeight)}setRowStyles(a,e){a._setStyle(`top`,this.getTilePosition(this.fixedRowHeight,e)),a._setStyle(`height`,K(this.getTileSize(this.fixedRowHeight,a.rowspan)))}getComputedHeight(){return[`height`,K(`${this.getTileSpan(this.fixedRowHeight)} + ${this.getGutterSpan()}`)]}reset(a){a._setListStyle([`height`,null]),a._tiles&&a._tiles.forEach(e=>{e._setStyle(`top`,null),e._setStyle(`height`,null)})}};var Ae=class extends ce{rowHeightRatio;baseTileHeight;constructor(a){super(),this._parseRatio(a)}setRowStyles(a,e,t,n){let o=t/this.rowHeightRatio;this.baseTileHeight=this.getBaseTileSize(o,n),a._setStyle(`marginTop`,this.getTilePosition(this.baseTileHeight,e)),a._setStyle(`paddingTop`,K(this.getTileSize(this.baseTileHeight,a.rowspan)))}getComputedHeight(){return[`paddingBottom`,K(`${this.getTileSpan(this.baseTileHeight)} + ${this.getGutterSpan()}`)]}reset(a){a._setListStyle([`paddingBottom`,null]),a._tiles.forEach(e=>{e._setStyle(`marginTop`,null),e._setStyle(`paddingTop`,null)})}_parseRatio(a){let e=a.split(`:`);e.length,this.rowHeightRatio=parseFloat(e[0])/parseFloat(e[1])}};var Pe=class extends ce{setRowStyles(a,e){let t=100/this._rowspan,n=(this._rows-1)/this._rows,o=this.getBaseTileSize(t,n);a._setStyle(`top`,this.getTilePosition(o,e)),a._setStyle(`height`,K(this.getTileSize(o,a.rowspan)))}reset(a){a._tiles&&a._tiles.forEach(e=>{e._setStyle(`top`,null),e._setStyle(`height`,null)})}};function K(i){return`calc(${i})`}function Ot(i){return i.match(/([A-Za-z%]+)$/)?i:`${i}px`}var si=`fit`;var Bt=(()=>{class i{_element=M(nr);_dir=M(Vn,{optional:!0});_cols;_tileCoordinator;_rowHeight;_gutter=`1px`;_tileStyler;_tiles;get cols(){return this._cols}set cols(e){this._cols=Math.max(1,Math.round(Dt(e)))}get gutterSize(){return this._gutter}set gutterSize(e){this._gutter=`${e??``}`}get rowHeight(){return this._rowHeight}set rowHeight(e){let t=`${e??``}`;t!==this._rowHeight&&(this._rowHeight=t,this._setTileStyler(this._rowHeight))}ngOnInit(){this._checkCols(),this._checkRowHeight()}ngAfterContentChecked(){this._layoutTiles()}_checkCols(){this.cols}_checkRowHeight(){this._rowHeight||this._setTileStyler(`1:1`)}_setTileStyler(e){this._tileStyler&&this._tileStyler.reset(this),e===si?this._tileStyler=new Pe:e&&e.indexOf(`:`)>-1?this._tileStyler=new Ae(e):this._tileStyler=new Te(e)}_layoutTiles(){this._tileCoordinator||(this._tileCoordinator=new xe);let e=this._tileCoordinator,t=this._tiles.filter(o=>!o._gridList||o._gridList===this),n=this._dir?this._dir.value:`ltr`;this._tileCoordinator.update(this.cols,t),this._tileStyler.init(this.gutterSize,e,this.cols,n),t.forEach((o,c)=>{let U=e.positions[c];this._tileStyler.setStyle(o,U.row,U.col)}),this._setListStyle(this._tileStyler.getComputedHeight())}_setListStyle(e){e&&(this._element.nativeElement.style[e[0]]=e[1])}static ɵfac=function(t){return new(t||i)};static ɵcmp=JC({type:i,selectors:[[`mat-grid-list`]],contentQueries:function(t,n,o){if(t&1&&Jm(o,Fe,5),t&2){let c;HI(c=$I())&&(n._tiles=c)}},hostAttrs:[1,`mat-grid-list`],hostVars:1,hostBindings:function(t,n){t&2&&Um(`cols`,n.cols)},inputs:{cols:`cols`,gutterSize:`gutterSize`,rowHeight:`rowHeight`},exportAs:[`matGridList`],features:[Ew([{provide:Ht,useExisting:i}])],ngContentSelectors:zt,decls:2,vars:0,template:function(t,n){t&1&&(jI(),Vl(0,`div`),BI(1),Hl())},styles:[ri],encapsulation:2})}return i})();var Lt=(()=>{class i{static ɵfac=function(t){return new(t||i)};static ɵmod=Rl({type:i});static ɵinj=Qi({imports:[De,Nt,De]})}return i})();var li=[`*`,[[`mat-chip-avatar`],[``,`matChipAvatar`,``]],[[`mat-chip-trailing-icon`],[``,`matChipRemove`,``],[``,`matChipTrailingIcon`,``]]];var pi=[`*`,`mat-chip-avatar, [matChipAvatar]`,`mat-chip-trailing-icon,[matChipRemove],[matChipTrailingIcon]`];function hi(i,a){i&1&&(Ys(0,`span`,3),BI(1,1),Bl())}function mi(i,a){i&1&&(Ys(0,`span`,6),BI(1,2),Bl())}var ui=[`*`];var gi=new V(`mat-chips-default-options`,{providedIn:`root`,factory:()=>({separatorKeyCodes:[13]})});var jt=new V(`MatChipAvatar`);var Vt=new V(`MatChipTrailingIcon`);var Gt=new V(`MatChipEdit`);var qt=new V(`MatChipRemove`);var $t=new V(`MatChip`);var Kt=(()=>{class i{_elementRef=M(nr);_parentChip=M($t);_isPrimary=!0;_isLeading=!1;get disabled(){return this._disabled||this._parentChip?.disabled||!1}set disabled(e){this._disabled=e}_disabled=!1;tabIndex=-1;_allowFocusWhenDisabled=!1;_getDisabledAttribute(){return this.disabled&&!this._allowFocusWhenDisabled?``:null}constructor(){M(R).load(tn),this._elementRef.nativeElement.nodeName===`BUTTON`&&this._elementRef.nativeElement.setAttribute(`type`,`button`)}focus(){this._elementRef.nativeElement.focus()}static ɵfac=function(t){return new(t||i)};static ɵdir=Ol({type:i,selectors:[[``,`matChipContent`,``]],hostAttrs:[1,`mat-mdc-chip-action`,`mdc-evolution-chip__action`,`mdc-evolution-chip__action--presentational`],hostVars:8,hostBindings:function(t,n){t&2&&(Um(`disabled`,n._getDisabledAttribute())(`aria-disabled`,n.disabled),sg(`mdc-evolution-chip__action--primary`,n._isPrimary)(`mdc-evolution-chip__action--secondary`,!n._isPrimary)(`mdc-evolution-chip__action--trailing`,!n._isPrimary&&!n._isLeading))},inputs:{disabled:[2,`disabled`,`disabled`,ab],tabIndex:[2,`tabIndex`,`tabIndex`,e=>e==null?-1:cb(e)],_allowFocusWhenDisabled:`_allowFocusWhenDisabled`}})}return i})();var _i=(()=>{class i extends Kt{_getTabindex(){return this.disabled&&!this._allowFocusWhenDisabled?null:this.tabIndex.toString()}_handleClick(e){!this.disabled&&this._isPrimary&&(e.preventDefault(),this._parentChip._handlePrimaryActionInteraction())}_handleKeydown(e){(e.keyCode===13||e.keyCode===32)&&!this.disabled&&this._isPrimary&&!this._parentChip._isEditing&&(e.preventDefault(),this._parentChip._handlePrimaryActionInteraction())}static ɵfac=(()=>{let e;return function(n){return(e||(e=lh(i)))(n||i)}})();static ɵdir=Ol({type:i,selectors:[[``,`matChipAction`,``]],hostVars:3,hostBindings:function(t,n){t&1&&Qm(`click`,function(c){return n._handleClick(c)})(`keydown`,function(c){return n._handleKeydown(c)}),t&2&&(Um(`tabindex`,n._getTabindex()),sg(`mdc-evolution-chip__action--presentational`,!1))},features:[Fm]})}return i})();var Re=(()=>{class i{_changeDetectorRef=M(xg);_elementRef=M(nr);_tagName=M(ej);_ngZone=M(Te$1);_focusMonitor=M(Ct);_globalRippleOptions=M(Kt$1,{optional:!0});_document=M(Ge);_onFocus=new we$1;_onBlur=new we$1;_isBasicChip=!1;role=null;_hasFocusInternal=!1;_pendingFocus=!1;_actionChanges;_animationsDisabled=K$1();_allLeadingIcons;_allTrailingIcons;_allEditIcons;_allRemoveIcons;_hasFocus(){return this._hasFocusInternal}id=M(Bt$1).getId(`mat-mdc-chip-`);ariaLabel=null;ariaDescription=null;_chipListDisabled=!1;_hadFocusOnRemove=!1;_textElement;get value(){return this._value!==void 0?this._value:this._textElement.textContent.trim()}set value(e){this._value=e}_value;color;removable=!0;highlighted=!1;disableRipple=!1;get disabled(){return this._disabled||this._chipListDisabled}set disabled(e){this._disabled=e}_disabled=!1;removed=new jt$1;destroyed=new jt$1;basicChipAttrName=`mat-basic-chip`;leadingIcon;editIcon;trailingIcon;removeIcon;primaryAction;_rippleLoader=M(Je);_injector=M(Be$1);constructor(){let e=M(R);e.load(tn),e.load(Ot$1),this._monitorFocus(),this._rippleLoader?.configureRipple(this._elementRef.nativeElement,{className:`mat-mdc-chip-ripple`,disabled:this._isRippleDisabled()})}ngOnInit(){this._isBasicChip=this._elementRef.nativeElement.hasAttribute(this.basicChipAttrName)||this._tagName.toLowerCase()===this.basicChipAttrName}ngAfterViewInit(){this._textElement=this._elementRef.nativeElement.querySelector(`.mat-mdc-chip-action-label`),this._pendingFocus&&(this._pendingFocus=!1,this.focus())}ngAfterContentInit(){this._actionChanges=r0(this._allLeadingIcons.changes,this._allTrailingIcons.changes,this._allEditIcons.changes,this._allRemoveIcons.changes).subscribe(()=>this._changeDetectorRef.markForCheck())}ngDoCheck(){this._rippleLoader.setDisabled(this._elementRef.nativeElement,this._isRippleDisabled())}ngOnDestroy(){this.destroyed.emit({chip:this}),this.destroyed.complete(),this._focusMonitor.stopMonitoring(this._elementRef),this._rippleLoader?.destroyRipple(this._elementRef.nativeElement),this._actionChanges?.unsubscribe()}remove(){this.removable&&(this._hadFocusOnRemove=this._hasFocus(),this.removed.emit({chip:this}))}_isRippleDisabled(){return this.disabled||this.disableRipple||this._animationsDisabled||this._isBasicChip||!this._hasInteractiveActions()||!!this._globalRippleOptions?.disabled}_hasTrailingIcon(){return!!(this.trailingIcon||this.removeIcon)}_handleKeydown(e){(e.keyCode===8&&!e.repeat||e.keyCode===46)&&(e.preventDefault(),this.remove())}focus(){this.disabled||(this.primaryAction?this.primaryAction.focus():this._pendingFocus=!0)}_getSourceAction(e){return this._getActions().find(t=>{let n=t._elementRef.nativeElement;return n===e||n.contains(e)})}_getActions(){let e=[];return this.editIcon&&e.push(this.editIcon),this.primaryAction&&e.push(this.primaryAction),this.removeIcon&&e.push(this.removeIcon),e}_handlePrimaryActionInteraction(){}_hasInteractiveActions(){return this._getActions().length>0}_edit(e){}_monitorFocus(){this._focusMonitor.monitor(this._elementRef,!0).subscribe(e=>{let t=e!==null;t!==this._hasFocusInternal&&(this._hasFocusInternal=t,t?this._onFocus.next({chip:this}):(this._changeDetectorRef.markForCheck(),setTimeout(()=>this._ngZone.run(()=>this._onBlur.next({chip:this})))))})}static ɵfac=function(t){return new(t||i)};static ɵcmp=JC({type:i,selectors:[[`mat-basic-chip`],[``,`mat-basic-chip`,``],[`mat-chip`],[``,`mat-chip`,``]],contentQueries:function(t,n,o){if(t&1&&Jm(o,jt,5)(o,Gt,5)(o,Vt,5)(o,qt,5)(o,jt,5)(o,Vt,5)(o,Gt,5)(o,qt,5),t&2){let c;HI(c=$I())&&(n.leadingIcon=c.first),HI(c=$I())&&(n.editIcon=c.first),HI(c=$I())&&(n.trailingIcon=c.first),HI(c=$I())&&(n.removeIcon=c.first),HI(c=$I())&&(n._allLeadingIcons=c),HI(c=$I())&&(n._allTrailingIcons=c),HI(c=$I())&&(n._allEditIcons=c),HI(c=$I())&&(n._allRemoveIcons=c)}},viewQuery:function(t,n){if(t&1&&eg(_i,5),t&2){let o;HI(o=$I())&&(n.primaryAction=o.first)}},hostAttrs:[1,`mat-mdc-chip`],hostVars:31,hostBindings:function(t,n){t&1&&Qm(`keydown`,function(c){return n._handleKeydown(c)}),t&2&&(Zm(`id`,n.id),Um(`role`,n.role)(`aria-label`,n.ariaLabel),tw(`mat-`+(n.color||`primary`)),sg(`mdc-evolution-chip`,!n._isBasicChip)(`mdc-evolution-chip--disabled`,n.disabled)(`mdc-evolution-chip--with-trailing-action`,n._hasTrailingIcon())(`mdc-evolution-chip--with-primary-graphic`,n.leadingIcon)(`mdc-evolution-chip--with-primary-icon`,n.leadingIcon)(`mdc-evolution-chip--with-avatar`,n.leadingIcon)(`mat-mdc-chip-with-avatar`,n.leadingIcon)(`mat-mdc-chip-highlighted`,n.highlighted)(`mat-mdc-chip-disabled`,n.disabled)(`mat-mdc-basic-chip`,n._isBasicChip)(`mat-mdc-standard-chip`,!n._isBasicChip)(`mat-mdc-chip-with-trailing-icon`,n._hasTrailingIcon())(`_mat-animation-noopable`,n._animationsDisabled))},inputs:{role:`role`,id:`id`,ariaLabel:[0,`aria-label`,`ariaLabel`],ariaDescription:[0,`aria-description`,`ariaDescription`],value:`value`,color:`color`,removable:[2,`removable`,`removable`,ab],highlighted:[2,`highlighted`,`highlighted`,ab],disableRipple:[2,`disableRipple`,`disableRipple`,ab],disabled:[2,`disabled`,`disabled`,ab]},outputs:{removed:`removed`,destroyed:`destroyed`},exportAs:[`matChip`],features:[Ew([{provide:$t,useExisting:i}])],ngContentSelectors:pi,decls:8,vars:2,consts:[[1,`mat-mdc-chip-focus-overlay`],[1,`mdc-evolution-chip__cell`,`mdc-evolution-chip__cell--primary`],[`matChipContent`,``],[1,`mdc-evolution-chip__graphic`,`mat-mdc-chip-graphic`],[1,`mdc-evolution-chip__text-label`,`mat-mdc-chip-action-label`],[1,`mat-mdc-chip-primary-focus-indicator`,`mat-focus-indicator`],[1,`mdc-evolution-chip__cell`,`mdc-evolution-chip__cell--trailing`]],template:function(t,n){t&1&&(jI(li),Gm(0,`span`,0),Ys(1,`span`,1)(2,`span`,2),vI(3,hi,2,0,`span`,3),Ys(4,`span`,4),BI(5),Gm(6,`span`,5),Bl()()(),vI(7,mi,2,0,`span`,6)),t&2&&(vE(3),EI(n.leadingIcon?3:-1),vE(4),EI(n._hasTrailingIcon()?7:-1))},dependencies:[Kt],styles:[`.mdc-evolution-chip,
...
`],encapsulation:2})}return i})();var Ut=(()=>{class i{static ɵfac=function(t){return new(t||i)};static ɵmod=Rl({type:i});static ɵinj=Qi({providers:[Bt$2,{provide:gi,useValue:{separatorKeyCodes:[13]}}],imports:[on,Nt]})}return i})();var ze=new V(`CdkAccordion`);var Zt=(()=>{class i{_stateChanges=new we$1;_openCloseAllActions=new we$1;id=M(Bt$1).getId(`cdk-accordion-`);multi=!1;openAll(){this.multi&&this._openCloseAllActions.next(!0)}closeAll(){this._openCloseAllActions.next(!1)}ngOnChanges(e){this._stateChanges.next(e)}ngOnDestroy(){this._stateChanges.complete(),this._openCloseAllActions.complete()}static ɵfac=function(t){return new(t||i)};static ɵdir=Ol({type:i,selectors:[[`cdk-accordion`],[``,`cdkAccordion`,``]],inputs:{multi:[2,`multi`,`multi`,ab]},exportAs:[`cdkAccordion`],features:[Ew([{provide:ze,useExisting:i}]),el]})}return i})();var Xt=(()=>{class i{accordion=M(ze,{optional:!0,skipSelf:!0});_changeDetectorRef=M(xg);_expansionDispatcher=M(Ee$2);_openCloseAllSubscription=Ee$1.EMPTY;closed=new jt$1;opened=new jt$1;destroyed=new jt$1;expandedChange=new jt$1;id=M(Bt$1).getId(`cdk-accordion-child-`);get expanded(){return this._expanded}set expanded(e){if(this._expanded!==e){if(this._expanded=e,this.expandedChange.emit(e),e){this.opened.emit();let t=this.accordion?this.accordion.id:this.id;this._expansionDispatcher.notify(this.id,t)}else this.closed.emit();this._changeDetectorRef.markForCheck()}}_expanded=!1;get disabled(){return this._disabled()}set disabled(e){this._disabled.set(e)}_disabled=xr(!1);_removeUniqueSelectionListener=()=>{};ngOnInit(){this._removeUniqueSelectionListener=this._expansionDispatcher.listen((e,t)=>{this.accordion&&!this.accordion.multi&&this.accordion.id===t&&this.id!==e&&(this.expanded=!1)}),this.accordion&&(this._openCloseAllSubscription=this._subscribeToOpenCloseAllActions())}ngOnDestroy(){this.opened.complete(),this.closed.complete(),this.destroyed.emit(),this.destroyed.complete(),this._removeUniqueSelectionListener(),this._openCloseAllSubscription.unsubscribe()}toggle(){this.disabled||(this.expanded=!this.expanded)}close(){this.disabled||(this.expanded=!1)}open(){this.disabled||(this.expanded=!0)}_subscribeToOpenCloseAllActions(){return this.accordion._openCloseAllActions.subscribe(e=>{this.disabled||(this.expanded=e)})}static ɵfac=function(t){return new(t||i)};static ɵdir=Ol({type:i,selectors:[[`cdk-accordion-item`],[``,`cdkAccordionItem`,``]],inputs:{expanded:[2,`expanded`,`expanded`,ab],disabled:[2,`disabled`,`disabled`,ab]},outputs:{closed:`closed`,opened:`opened`,destroyed:`destroyed`,expandedChange:`expandedChange`},exportAs:[`cdkAccordionItem`],features:[Ew([{provide:ze,useValue:void 0}])]})}return i})();var Yt=(()=>{class i{static ɵfac=function(t){return new(t||i)};static ɵmod=Rl({type:i});static ɵinj=Qi({})}return i})();var vi=[`body`];var yi=[`bodyWrapper`];var bi=[[[`mat-expansion-panel-header`]],`*`,[[`mat-action-row`]]];var xi=[`mat-expansion-panel-header`,`*`,`mat-action-row`];function Si(i,a){}var wi=[[[`mat-panel-title`]],[[`mat-panel-description`]],`*`];var Ci=[`mat-panel-title`,`mat-panel-description`,`*`];function Ni(i,a){i&1&&(Vl(0,`span`,1),Xf(),Vl(1,`svg`,2),Wm(2,`path`,3),Hl()())}var He=new V(`MAT_ACCORDION`);var Jt=new V(`MAT_EXPANSION_PANEL`);var Ii=(()=>{class i{_template=M(jr);_expansionPanel=M(Jt,{optional:!0});static ɵfac=function(t){return new(t||i)};static ɵdir=Ol({type:i,selectors:[[`ng-template`,`matExpansionPanelContent`,``]]})}return i})();var ei=new V(`MAT_EXPANSION_PANEL_DEFAULT_OPTIONS`);var Oe=(()=>{class i extends Xt{_viewContainerRef=M(Ur);_animationsDisabled=K$1();_document=M(Ge);_ngZone=M(Te$1);_elementRef=M(nr);_renderer=M(Oo);_cleanupTransitionEnd;get hideToggle(){return this._hideToggle||this.accordion&&this.accordion.hideToggle}set hideToggle(e){this._hideToggle=e}_hideToggle=!1;get togglePosition(){return this._togglePosition||this.accordion&&this.accordion.togglePosition}set togglePosition(e){this._togglePosition=e}_togglePosition;afterExpand=new jt$1;afterCollapse=new jt$1;_inputChanges=new we$1;accordion=M(He,{optional:!0,skipSelf:!0});_lazyContent;_body;_bodyWrapper;_portal;_headerId=M(Bt$1).getId(`mat-expansion-panel-header-`);constructor(){super();let e=M(ei,{optional:!0});this._expansionDispatcher=M(Ee$2),e&&(this.hideToggle=e.hideToggle)}_hasSpacing(){return this.accordion?this.expanded&&this.accordion.displayMode==="default":!1}_getExpandedState(){return this.expanded?`expanded`:`collapsed`}toggle(){this.expanded=!this.expanded}close(){this.expanded=!1}open(){this.expanded=!0}ngAfterContentInit(){this._lazyContent&&this._lazyContent._expansionPanel===this&&this.opened.pipe(D0(null),io(()=>this.expanded&&!this._portal),yr(1)).subscribe(()=>{this._portal=new u(this._lazyContent._template,this._viewContainerRef)}),this._setupAnimationEvents()}ngOnChanges(e){this._inputChanges.next(e)}ngOnDestroy(){super.ngOnDestroy(),this._cleanupTransitionEnd?.(),this._inputChanges.complete()}_containsFocus(){if(this._body){let e=this._document.activeElement,t=this._body.nativeElement;return e===t||t.contains(e)}return!1}_transitionEndListener=({target:e,propertyName:t})=>{e===this._bodyWrapper?.nativeElement&&t===`grid-template-rows`&&this._ngZone.run(()=>{this.expanded?this.afterExpand.emit():this.afterCollapse.emit()})};_setupAnimationEvents(){this._ngZone.runOutsideAngular(()=>{this._animationsDisabled?(this.opened.subscribe(()=>this._ngZone.run(()=>this.afterExpand.emit())),this.closed.subscribe(()=>this._ngZone.run(()=>this.afterCollapse.emit()))):setTimeout(()=>{let e=this._elementRef.nativeElement;this._cleanupTransitionEnd=this._renderer.listen(e,`transitionend`,this._transitionEndListener),e.classList.add(`mat-expansion-panel-animations-enabled`)},200)})}static ɵfac=function(t){return new(t||i)};static ɵcmp=JC({type:i,selectors:[[`mat-expansion-panel`]],contentQueries:function(t,n,o){if(t&1&&Jm(o,Ii,5),t&2){let c;HI(c=$I())&&(n._lazyContent=c.first)}},viewQuery:function(t,n){if(t&1&&eg(vi,5)(yi,5),t&2){let o;HI(o=$I())&&(n._body=o.first),HI(o=$I())&&(n._bodyWrapper=o.first)}},hostAttrs:[1,`mat-expansion-panel`],hostVars:4,hostBindings:function(t,n){t&2&&sg(`mat-expanded`,n.expanded)(`mat-expansion-panel-spacing`,n._hasSpacing())},inputs:{hideToggle:[2,`hideToggle`,`hideToggle`,ab],togglePosition:`togglePosition`},outputs:{afterExpand:`afterExpand`,afterCollapse:`afterCollapse`},exportAs:[`matExpansionPanel`],features:[Ew([{provide:He,useValue:void 0},{provide:Jt,useExisting:i}]),Fm,el],ngContentSelectors:xi,decls:9,vars:4,consts:[[`bodyWrapper`,``],[`body`,``],[1,`mat-expansion-panel-content-wrapper`],[`role`,`region`,1,`mat-expansion-panel-content`,3,`id`],[1,`mat-expansion-panel-body`],[3,`cdkPortalOutlet`]],template:function(t,n){t&1&&(jI(bi),BI(0),Ys(1,`div`,2,0)(3,`div`,3,1)(5,`div`,4),BI(6,1),jm(7,Si,0,0,`ng-template`,5),Bl(),BI(8,2),Bl()()),t&2&&(vE(),Um(`inert`,n.expanded?null:``),vE(2),zm(`id`,n.id),Um(`aria-labelledby`,n._headerId),vE(4),zm(`cdkPortalOutlet`,n._portal))},dependencies:[U],styles:[`.mat-expansion-panel {
  box-sizing: content-box;
  display: block;
  margin: 0;
  overflow: hidden;
