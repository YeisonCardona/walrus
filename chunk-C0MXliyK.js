...
`],encapsulation:2})}return i})();var Ne=(()=>{class i{static ɵfac=function(n){return new(n||i)};static ɵmod=Rl({type:i});static ɵinj=Qi({imports:[Nt$1]})}return i})();var yi=[`*`];var xi=`.mdc-list {
  margin: 0;
  padding: 8px 0;
