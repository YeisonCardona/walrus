import{$r as zm,Ft as V,Kt as Ys,Lt as Vf,Nn as jI,O as FI,On as ig,Rr as vE,Vn as kt,X as JC,at as M,bn as fw,bt as Qm,dt as Ol,f as Bf,i as AI,lr as pg,ot as Mw,p as Bl,qr as xw,u as BI,ut as Ob,vt as Qi,w as EI,wt as Rl,xr as sg,zr as vI}from"./chunk-DOWwT1r-.js";import{J as pr,N as Nt,V as br,r as G$1}from"./main-UHH4IKU2.js";import{t as v}from"./chunk-DRzFyaaJ.js";import{n as p}from"./chunk-CJ2q6KKp.js";var X=[`*`];var O=new V(`MAT_CARD_CONFIG`);var B=(()=>{class t{appearance;constructor(){let e=M(O,{optional:!0});this.appearance=e?.appearance||`raised`}static ɵfac=function(a){return new(a||t)};static ɵcmp=JC({type:t,selectors:[[`mat-card`]],hostAttrs:[1,`mat-mdc-card`,`mdc-card`],hostVars:8,hostBindings:function(a,r){a&2&&sg(`mat-mdc-card-outlined`,r.appearance===`outlined`)(`mdc-card--outlined`,r.appearance===`outlined`)(`mat-mdc-card-filled`,r.appearance===`filled`)(`mdc-card--filled`,r.appearance===`filled`)},inputs:{appearance:`appearance`},exportAs:[`matCard`],ngContentSelectors:X,decls:1,vars:0,template:function(a,r){a&1&&(jI(),BI(0))},styles:[`.mat-mdc-card {
  display: flex;
